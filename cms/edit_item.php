...
<?php
 ...
 ?>
	 	<FORM action="check_item_save.php" method="POST" enctype="multipart/form-data"><input type="hidden" name="item_id" value="<?php echo "$item_id"; ?>" />
...
<?php
	...
	//picture file upload below
	echo "      Picture: <input type=\"file\" name=\"uploaded\" value=\"$image\" id=\"$image\"><br />";   
