...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<FONT color=red><h2>Error with field: <?php echo $errors; ?></h2></font>
...
?>	
			...
			<?php if ($sku=="") echo "<font color=red> *required</font>"; ?>
	  		<br /><br />
	 		Please choose an image: <input id="uploaded" name="uploaded" type="file" /><?php echo "<font color=red> *required</font>"; ?>
	 		<br /><br />
